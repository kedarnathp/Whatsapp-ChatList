...
const chat_names = ["Virat Kohli", "Usain Bolt", "Maria Sharapova", "Cristiano Ronaldo", "Serena Williams", "LeBron James", "Roger Federer"];
const chat_names_length = chat_names.length;
const chat_msg = [
    "Have you seen 'Inception'? The dream within a dream concept blew my mind!",
    "'The Dark Knight' is my favorite Nolan movie. Heath Ledger's Joker was incredible!",
    "'Interstellar' made me think about the universe in a whole new way. The visuals were stunning!",
    "I just watched 'Dunkirk.' The storytelling through different timelines was brilliant.",
    "'Memento' is a masterpiece. The way the story unfolds backward is so unique!",
    "I'm a fan of 'The Prestige.' The twist at the end caught me completely off guard.",
    "'Tenet' was a bit confusing at first, but I loved how everything came together in the end."
];
